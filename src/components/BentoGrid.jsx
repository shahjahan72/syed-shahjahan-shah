    ...
    return (
        <section className="px-6 md:px-20 max-w-7xl mx-auto py-20 relative z-10">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 auto-rows-[240px]">
                {/* Project 1 - Printify Studio (This Site) */}
                <Card className="md:col-span-2 md:row-span-2 group relative overflow-hidden !p-0 border-white/5">
                    <Link to="/shop" className="absolute inset-0 z-20" aria-label="View Printify Studio" />
                    <div className="absolute inset-0 bg-gradient-to-t from-black/90 via-black/20 to-transparent z-10 pointer-events-none" />

                    <img
                        src="/assets/products/panaflex_main.jpg"
                        onError={(e) => e.target.src = 'https://images.unsplash.com/photo-1557821552-17105176677c?q=80&w=2669&auto=format&fit=crop'}
                        alt="Printify Studio"
                        loading="lazy"
                    ...
                    <div className="relative z-20 h-full flex flex-col justify-end p-8 pointer-events-none">
                        <div className="flex items-center gap-3 mb-2 translate-y-4 group-hover:translate-y-0 transition-transform">
                            <span className="bg-neon-purple text-white text-[10px] font-bold px-2 py-1 rounded">LIVE PROJECT</span>
                            <h3 className="text-3xl font-bold">Printify Studio</h3>
                        </div>
                        <p className="text-white/70 translate-y-4 opacity-0 group-hover:translate-y-0 group-hover:opacity-100 transition-all delay-75">
                            A complete E-commerce solution with dynamic pricing engine ('99 strategy'), WhatsApp order integration, and 3D visual elements.
                        </p>
                    </div>
                </Card>
                ...
                <Card className="md:col-span-1 md:row-span-1" delay={0.1}>
                    <div className="flex flex-col h-full justify-between">
                        ...
                        <div className="flex gap-4 items-center mt-4">
                            <a href={siteConfig.social.instagram} target="_blank" rel="noopener noreferrer" className="p-3 bg-white/5 rounded-full hover:bg-pink-600 hover:text-white transition-colors" title="Instagram">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5" /><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z" /><line x1="17.5" x2="17.51" y1="6.5" y2="6.5" /></svg>
                            </a>
                            <a href={`https://wa.me/${siteConfig.whatsapp.number}`} target="_blank" rel="noopener noreferrer" className="p-3 bg-white/5 rounded-full hover:bg-green-500 hover:text-white transition-colors" title="WhatsApp">
                            ...
                            <a href={siteConfig.social.linkedin} target="_blank" rel="noopener noreferrer" className="p-3 bg-white/5 rounded-full hover:bg-blue-600 hover:text-white transition-colors" title="LinkedIn">
